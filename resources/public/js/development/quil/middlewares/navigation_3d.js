...
var vec__1788 = axis;
var a_x = cljs.core.nth.call(null,vec__1788,(0),null);
var a_y = cljs.core.nth.call(null,vec__1788,(1),null);
var a_z = cljs.core.nth.call(null,vec__1788,(2),null);
var vec__1791 = v;
var x = cljs.core.nth.call(null,vec__1791,(0),null);
var y = cljs.core.nth.call(null,vec__1791,(1),null);
var z = cljs.core.nth.call(null,vec__1791,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__1794,p__1795){
var vec__1796 = p__1794;
var u1 = cljs.core.nth.call(null,vec__1796,(0),null);
var u2 = cljs.core.nth.call(null,vec__1796,(1),null);
var u3 = cljs.core.nth.call(null,vec__1796,(2),null);
var vec__1799 = p__1795;
var v1 = cljs.core.nth.call(null,vec__1799,(0),null);
var v2 = cljs.core.nth.call(null,vec__1799,(1),null);
var v3 = cljs.core.nth.call(null,vec__1799,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__1802_SHARP_){
return (p1__1802_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__1803_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__1804_SHARP_,angle_lr),angle_ud);
...
var map__1806 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__1806__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__1806__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__5455__auto__ = (function (){var pred__1808 = cljs.core._EQ_;
var expr__1809 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__1808.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__1809))){
return straight;
} else {
if(cljs.core.truth_(pred__1808.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__1809))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__1808.call(null,quil.middlewares.navigation_3d.space,expr__1809))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__1808.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__1809))){
return up;
} else {
if(cljs.core.truth_(pred__1808.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__1809))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__1808.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__1809))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__5455__auto__,map__1806,map__1806__$1,up,straight){
return (function (p1__1805_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__1805_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__5455__auto__,map__1806,map__1806__$1,up,straight))
);
} else {
return state;
}
...
return (function (p1__1811_SHARP_){
return cljs.core.merge.call(null,initial_state,p1__1811_SHARP_);
});})(initial_state))
);
});
/**
...
var map__1812_1823 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__1812_1824__$1 = (((((!((map__1812_1823 == null))))?(((((map__1812_1823.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1812_1823.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1812_1823):map__1812_1823);
var vec__1813_1825 = cljs.core.get.call(null,map__1812_1824__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_1826 = cljs.core.nth.call(null,vec__1813_1825,(0),null);
var c_y_1827 = cljs.core.nth.call(null,vec__1813_1825,(1),null);
var c_z_1828 = cljs.core.nth.call(null,vec__1813_1825,(2),null);
var vec__1816_1829 = cljs.core.get.call(null,map__1812_1824__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_1830 = cljs.core.nth.call(null,vec__1816_1829,(0),null);
var u_y_1831 = cljs.core.nth.call(null,vec__1816_1829,(1),null);
var u_z_1832 = cljs.core.nth.call(null,vec__1816_1829,(2),null);
var vec__1819_1833 = cljs.core.get.call(null,map__1812_1824__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_1834 = cljs.core.nth.call(null,vec__1819_1833,(0),null);
var p_y_1835 = cljs.core.nth.call(null,vec__1819_1833,(1),null);
var p_z_1836 = cljs.core.nth.call(null,vec__1819_1833,(2),null);
quil.core.camera.call(null,p_x_1834,p_y_1835,p_z_1836,(p_x_1834 + c_x_1826),(p_y_1835 + c_y_1827),(p_z_1836 + c_z_1828),u_x_1830,u_y_1831,u_z_1832);
